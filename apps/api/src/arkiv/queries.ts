...
export const getAgreementIdentity = async (repo: ArkivRepository, escrow: Address, role: "client" | "arbiter") => (await repo.find("agreement_identity", "identity_id", `${escrow.toLowerCase()}:${role}`)).at(0)
